...
<?php if ( post_password_required() ) : ?>
				<?php /*?><p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'yiw' ); ?></p><?php */?>
                
                <p class="nopassword">  <?php _e( 'If you do not have a password,  &nbsp;<a href="http://salmon.newmayodesigns.com/password-price-list/">Click Here </a>to request one.', 'yiw' ); ?></p>
			</div><!-- #comments -->
<?php
