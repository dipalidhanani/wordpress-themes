                            ...
                            <?php if($blog_type=='big'): ?>
                                <div class="post_header group">
                                    ...
                                    <div class="post_title">
                                        ...
                                        <?php else : ?>
                                            <div class="bannerlinks1"><div class="head1"><a href="<?php the_permalink() ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'yiw' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php echo $title ?></a></div></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<!--                       =========================================================================================-->        
                                ...
                                <div class="post_nothumb post_content group">
                                    ...
                                    <div class="post_title">
                                        <?php if ( is_single() ) : ?>
                                           <div class="bannerlinks1"><div class="head1"><?php echo $title ?></div>
                                        <?php else : ?>
                                           <div class="bannerlinks1"><div class="head1"><a href="<?php the_permalink() ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'yiw' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php echo $title ?></a></div>
                                        <?php endif; ?>
                                    </div>
