...
<iframe width="48" scrolling="no" height="20" frameborder="0" style="border: medium none;" src="http://www.houzz.com/buttonWidget/1?url=<?php echo $url;?>&img=<?php echo $image;?>&title=<?php echo $title;?>&hzid=10878&ref=http://salmon.newmayodesigns.com"></iframe>*/?>

<a class="houzz-share-button" data-url="<?php echo $url;?>" data-hzid="10878" data-img="<?php echo $image;?>" data-title="<?php echo $title;?>" data-desc="<?php echo $contents;?>" data-category="<?php echo $cats;?>" data-showcount="1" href="http://www.houzz.com">Houzz</a>
