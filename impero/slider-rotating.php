				...
				<div id="rm_container" class="rm_container">
					...
					<ul>	
						...
						?>
							...
							<li data-images="rm_container_<?php echo $count; ?>" data-rotation="<?php echo $data_rotation; ?>" style="width:<?php echo $width_li ?>px">
					...
					<h2><?php echo yiw_get_option('slider_rotating_title'); ?></h2>
