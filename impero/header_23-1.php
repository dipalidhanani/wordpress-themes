...
<div class="so-midia">
<ul>
<li><a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/ha-icon.png"></a></li>
<li><a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/fb-icon.png"></a></li>
<li><a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/gp-icon.png"></a></li>
<li><a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/tw-icon.png"></a></li>
<li><a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/email-icon.png"></a></li>
</ul>
<h2>207-384-5540</h2>
</div>
