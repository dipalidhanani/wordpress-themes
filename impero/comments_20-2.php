...
<?php
	...
	$image = echo_first_image($post->ID);
	$content = $post->post_content;	
	$categories = get_the_category($post->ID);
	$cats = '';
	$houzz_id = yiw_get_option('houzz_id');
	if( !empty( $categories ) ){		
	...
	$contents = substr( strip_tags( $post->post_content ), 0, 50 );*/
?>

<!--<a class="houzz-share-button" data-url="<?php echo $url;?>" data-hzid="<?php echo $houzz_id;?>" data-img="<?php echo $image;?>" data-title="<?php echo $title;?>" data-desc="<?php echo $contents;?>" data-category="<?php echo $cats;?>" data-showcount="1" href="http://www.houzz.com">Houzz</a>
...
//Reveal social links
 ...
 $('.sociallinks').toggle(
		function() {
	       $(this).next('div.socialbox').slideDown();
		   $(this).addClass('close');
		},
		function() {
		   $(this).next('div.socialbox').fadeOut();
		   $(this).removeClass('close');
	  }
	); // end toggle

//	reveal popdown pages section-->
...
<div id="social">
    <p class="sociallinks close"><img width="59" height="20" alt="links to social sites" src="<?php bloginfo('template_directory'); ?>/images/sharethis.png"></p>
    <div class="socialbox" style="display: block;">
    <a target="_blank" href="https://www.facebook.com/salmonfallsnurserylandscaping">
    	<span data-icon="F" class="icon social gray medium" style="display: inline-block;">
        <span aria-hidden="true">&#x22; </span></span>
     </a>
     <a target="_blank" href="https://twitter.com/SalmonFallsNL"><span data-icon="T" class="icon social gray medium" style="display: inline-block;">
     	<span aria-hidden="true">#</span></span>
        </a><a target="_blank" href="#"><span data-icon="I" class="icon social gray medium" style="display: inline-block;"><span aria-hidden="true">4</span></span></a>
        </a><a target="_blank" href="http://www.houzz.com/pro/salmonfallsnurseryandlandscaping"><span data-icon="I" class="icon social gray medium" style="display: inline-block;"><span aria-hidden="true"><img width="23" height="22" alt="links to social sites" src="<?php bloginfo('template_directory'); ?>/images/ha-icon.png"></span></span></a>
    </div>
</div>
