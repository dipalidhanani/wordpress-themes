<?php
/*
  Plugin Name: WeaverTek WooCommerce Aramex
  Plugin URI: http://www.weavertek.com
  Description: Automatic Shipping Calculation using the Aramex Shipping API for WooCommerce
  Version: 1.0.0
  Author: Mohamed Elkholy
  Author URI: http://www.weavertek.com
  Requires at least: 3.1
  Tested up to: 3.3.1

  Copyright: © 2012-2014 WeaverTek Inc.
  License: GNU General Public License v3.0
  License URI: http://www.gnu.org/licenses/gpl-3.0.html
 */
 
if ( ! class_exists( 'WEAVERTEK_Auto_Update' ) )
	require_once( 'weavertek-updates/weavertek_auto_update.php' );

function weavertek_aramex_update_init(){
	$weavertek_update = new WEAVERTEK_Auto_Update( get_plugin_data(__FILE__), plugin_basename( __FILE__ ), '4548833', 'QXKYTd5u3oMPhJPPeHNccNvvO' );
}
add_action('admin_init', 'weavertek_aramex_update_init', 11);
...
//		}
			 ...
			 $shipping_services_wsdl_path = get_site_url().'/wp-content/plugins/weavertek-woocommerce-shipping-aramex/classes/wsdl/production/shipping_services_api_wsdl.wsdl';
	...
	try {
		...
		//$shipments_tracking_wsdl_path = get_site_url().'/wp-content/plugins/weavertek-woocommerce-shipping-aramex/classes/wsdl/production/shipments_tracking_api_wsdl.wsdl';
