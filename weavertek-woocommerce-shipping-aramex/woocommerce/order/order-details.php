...
$shipment_number = $_REQUEST['awb_number'];
		...
		$shipments_tracking_wsdl_path = $siteurl.'/wp-content/plugins/weavertek-woocommerce-shipping-aramex/classes/wsdl/production/shipments_tracking_api_wsdl.wsdl';
