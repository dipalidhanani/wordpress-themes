...
<td width="21%">(Work) : </td><td width="28%"><div class="er"><input id="telephone_work" type="text" name="telephone_work" class="required"/></div></td>
</tr>
<tr>
<td>Fax : </td><td><div class="er"><input id="fax" type="text" name="fax" class="required number" /></div></td>
<td>Email :</td><td>
...
<tr>
<td width="25%">Participant Signature :</td>
<td width="26%"><div class="er"> <input id="participant_signature2" type="text" name="participant_signature2" class="required"/></div></td>

<td width="25%">Date : </td>
<td width="26%"><div class="er"><input id="date2" type="text" name="date2" class="required date"/></div></td>
