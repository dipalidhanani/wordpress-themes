...
{
   echo "<span style='text-align: center;display: block; color: green;'>PDF has been sent.</span>";
}
...
<td width="26%">
<input id="passport_full_name" type="text" name="passport_full_name" />
</td>
<td width="21%">Shirt Size :</td><td width="28%">
<select name="passport_shirt_size"> 
...
<tr>
<td>Passport Number : </td><td><input id="passport_number" type="text" name="passport_number" /></td>
<td>Passport Nationality : </td><td><input id="passport_nationality" type="text" name="passport_nationality" /></td>
</tr>
<tr>
<td>Issue Date : </td><td><input id="passport_issue_date" type="text" name="passport_issue_date" /></td>
<td>Expiration Date : </td><td><input id="passport_expiration_date" type="text" name="passport_expiration_date" /></td>
</tr>
<tr>
<td>Place of issue : </td><td><input id="passport_place_of_issue" type="text" name="passport_place_of_issue" /></td>
<td>Sex :</td><td>
<select name="passport_shirt_type">
<option selected="selected" value="M">M</option>
<option value="F">F</option> 
</select></td>
</tr>
<tr>
<td>Date of birth : </td><td><input id="passport_date_of_birth" type="text" name="passport_date_of_birth" /></td>
<td></td><td></td>
</tr>
</tbody>
</table>
...
<tr>
<td>Street (As appears in passport) :</td><td  colspan="3"> <input id="street" type="text" name="street" size="70" /></td>
</tr>
<tr>
<td>City State Zip :</td><td colspan="3"><input id="city_state_zip" type="text" name="city_state_zip" /></td>
</tr>
<tr>
<td width="25%">Telephone(Home) : </td><td width="26%"><input id="telephone_home" type="text" name="telephone_home" /></td>
<td width="21%">(Work) : </td><td width="28%"><input id="telephone_work" type="text" name="telephone_work" /></td>
</tr>
<tr>
<td>Fax : </td><td><input id="fax" type="text" name="fax" /></td>
<td>Email :</td><td>
<input id="email" type="text" name="email" /></td>
</tr>
<tr>
<td>Physical Condition : </td><td><input id="physical_condition" type="text" name="physical_condition" /></td>
<td>Dietary Requirement : </td><td><input id="dietary_requirement" type="text" name="dietary_requirement" /></td>
</tr>
<tr>
<td >Health Concerns : </td><td colspan="3"><input id="health_concerns" type="text" name="health_concerns" /></td>
</tr>
<tr>
<td>Emergency Contact Name &amp; Telephone : </td><td  colspan="3"><input id="emergency_contact_name" type="text" name="emergency_contact_name" /></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td width="50%">Participant Signature : <input id="participant_signature1" type="text" name="participant_signature1" /></td>
<td width="50%">Date : <input id="date1" type="text" name="date1" /></td>
</tr>
<tr>
<td style="border-bottom: 1px solid #000; width: 100%;padding: 3px;" colspan="2"></td>
</tr>
</tbody>
</table>
<table style="padding: 10px;" width="100%">
<tbody>
<tr>
<td width="50%">Participant Signature : <input id="participant_signature2" type="text" name="participant_signature2" /></td>
<td width="50%">Date : <input id="date2" type="text" name="date2" /></td>
</tr>
<tr>
<td style="border-bottom: 1px solid #000; width: 100%;padding: 3px;" colspan="2"></td>
</tr>
...
<table style="padding: 10px; padding: 10px; text-align: center;" width="100%">
<tbody>
<tr>
<td>
<h1>TRAVEL INSURANCE ACCEPTANCE</h1>
...
<td width="25%"><input id="participant_signature" type="text" name="participant_signature" /></td>
<td width="25%">Date : </td>
<td width="25%"><input id="date" type="text" name="date" /></td>
</tr>
<tr>
...
<td width="25%"><input id="print_name" type="text" name="print_name" /></td>
<td width="25%">Trip Dates : </td>
<td width="25%"><input id="trip_dates" type="text" name="trip_dates" /></td>
</tr>
<tr>
<td style="border-bottom: 1px solid #000; width: 100%;padding: 3px;" colspan="4"></td>
</tr>
...
<td width="25%"><input id="insurance_company" type="text" name="insurance_company" /></td>
<td width="25%">Policy Number : </td>
<td width="25%"><input id="policy_number" type="text" name="policy_number" /></td>
</tr>
<tr>
<td style="border-bottom: 1px solid #000; width: 100%;padding: 3px;" colspan="4"></td>
</tr>
...
<tbody>
<tr>
<td>Insurance company contact telephone (if not using Travel Guard): <input id="insurance_company_contact" type="text" name="insurance_company_contact" /></td>
</tr>
<tr>
<td style="border-bottom: 1px solid #000; width: 100%;padding: 3px;" colspan="4"></td>
</tr>
<tr>
<td colspan="2" style="text-align: center;"><input id="submit" style="font-size: 21px; height: 40px; width: 132px;" type="submit" name="submit" value="Submit" /></td>
</tr>
</tbody>
</table>
</form></div>
