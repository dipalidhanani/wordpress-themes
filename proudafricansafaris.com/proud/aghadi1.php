...
$html='<table style="border: 1px solid;" width="700" border="0" cellspacing="0" cellpadding="5">
...
<tr>
<td colspan="2" style="text-align: center;"><strong><h1>Aghadi Reservations Booking Form</h1></strong>
</td>
</tr>
<tr>
...
<tr>
<td width="25%">Telephone(Home) : </td><td width="26%"><div class="er"><input id="telephone_home" type="text" name="telephone_home" class="required" /></div></td>
<td width="21%">(Work) : </td><td width="28%"><div class="er"><input id="telephone_work" type="text" name="telephone_work" /></div></td>
</tr>
<tr>
<td>Fax : </td><td><div class="er"><input id="fax" type="text" name="fax" /></div></td>
<td>Email :</td><td>
