<div class="office-info">
    ...
    <div class="office-hours">
        ...
        <div class="announcement">
	        <div class="announcement-title1">{__ 'ANNOUNCEMENTS'}</div>
	...
	<div class="office-telephone clearfix">
		...
		<span class="office-info-data"><a href="callto:{$options->phone_number}">{$options->phone_number}</a></span>
	...
	<div class="office-email clearfix">
		...
		<span class="office-info-data"><a href="mailto:{$options->email}">{$options->email}</a></span>
	</div>
	{/if}
</div>