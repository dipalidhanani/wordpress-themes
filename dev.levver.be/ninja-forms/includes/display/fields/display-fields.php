...
function ninja_forms_display_fields($form_id){
	...
	if( is_admin() ){
		...
		$id = $_REQUEST['sub_id'];
		$get_data = $wpdb->get_row("select * from {$submission_tbl} where id = {$id}");
		$sub_data = unserialize( $get_data->sub_data );
		echo '<table class="wp-list-table widefat fixed posts" cellpadding="6" cellspacing="0" style="margin-bottom: 20px;">';
		
			if( 'Elektriciteit & Gas' == $sub_data['product_type'] ){
				$prod_name = explode('{@}', $sub_data['product_name']);
				$contract_period = explode('{@}', $sub_data['contract_period']);
				/*	Product Name	*/
				echo '<tr>';
					echo '<td valign="top" style="width:16%">';
						echo '<b>Produktnaam:</b>&nbsp;&nbsp;&nbsp; '; 
					echo '</td>';
					
					echo '<td valign="top">';
						echo 'Elektriciteit: '.$prod_name[0].'<br/>';
						echo 'Gas: '.$prod_name[1];
					echo '</td>';
				echo '</tr>';
			}else{
				/*	Product Name	*/
			...
			echo '<tr>';
				echo '<td valign="top" style="width:16%">';
					echo '<b>Type product: </b>';
				echo '</td>';

				echo '<td valign="top">';
					echo $sub_data['product_type'];
				echo '</td>';	
			echo '</tr>';
			...
			if( 'Elektriciteit & Gas' == $sub_data['product_type'] ){
				...
				echo '<tr>';
					echo '<td valign="top" style="width:16%">';
						echo '<b>Contract periode:</b>&nbsp;&nbsp;&nbsp; '; 
					echo '</td>';
					
					echo '<td valign="top">';
						echo 'Elektriciteit: '.$contract_period[0].'<br/>';
						echo 'Gas: '.$contract_period[1];
					echo '</td>';
				echo '</tr>';
			}else{
				/*	Contact period	*/
				echo '<tr>';
					...
					echo '<td valign="top">';
						echo $sub_data['contract_period'].' jaar';
					echo '</td>';
				echo '</tr>';
			}
			...
			echo '<tr>';
				...
				echo '<td valign="top">';
					echo ( $sub_data['meter_type'] ) ? $sub_data['meter_type'] : '-';
				echo '</td>';
			echo '</tr>';
			...
			echo '<tr>';
				echo '<td valign="top" style="width:16%">';
					echo '<b>Person Value:</b>&nbsp;&nbsp;&nbsp; '; 
				echo '</td>';
				
				echo '<td valign="top">';
					echo ( $sub_data['person_value'] ) ? $sub_data['person_value'] : '-' ;
				echo '</td>';
			echo '</tr>';
			...
			echo '<tr>';
				echo '<td valign="top" style="width:16%">';
					echo '<b>Search Electricity:</b>&nbsp;&nbsp;&nbsp; '; 
				echo '</td>';
				
				echo '<td valign="top">';
					echo ( $sub_data['srch_electricity'] ) ? $sub_data['srch_electricity'] : '-';
				echo '</td>';
			echo '</tr>';
			...
			echo '<tr>';
				echo '<td valign="top" style="width:16%">';
					echo '<b>Search Electricity2:</b>&nbsp;&nbsp;&nbsp; '; 
				echo '</td>';
				
				echo '<td valign="top">';
					echo ( $sub_data['srch_electricity2'] ) ? $sub_data['srch_electricity2'] : '-';
				echo '</td>';
			echo '</tr>';
			...
			echo '<tr>';
				...
				echo '<td valign="top">';
					echo ( $sub_data['srch_gas'] ) ? $sub_data['srch_gas'] : '-';
				echo '</td>';
			echo '</tr>';
			...
			echo '<tr>';
				echo '<td valign="top" style="width:16%">';
					echo '<b>Include Discount:</b>&nbsp;&nbsp;&nbsp; '; 
				echo '</td>';
				
				echo '<td valign="top">';
					echo ( $sub_data['include_discount'] ) ? $sub_data['include_discount'] . ' ( Yes ) ' : '-' ;
				echo '</td>';
			echo '</tr>';
		echo '<table>';	
	}
	/*	To Hide some fields end 	*/
