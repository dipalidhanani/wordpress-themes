            ...
            <?php foreach ($posts_array as $post_item){
                ...
                <article class="<?php echo esc_attr( join( ' ', get_post_class( array( 'course', 'post' ), $post_id ) ) ); ?>">
                    ...
                    <div class="course-content">
                        ...
                        <section class="entry">
                            <p class="sensei-course-meta test">
                    ...
                    <?php
                        if ( class_exists( 'Sensei_Course_Participants' ) ) {
                            Sensei_Course_Participants()->display_course_participant_count( $post_item );
                        }
                    ?>
                    <p class="sensei-view-course"><a class="button" href="<?php echo get_permalink( $post_id ); ?>"><?php _e( 'View Course', 'woothemes' ); ?></a></p>
                    </footer>
                </article>
                <?php
