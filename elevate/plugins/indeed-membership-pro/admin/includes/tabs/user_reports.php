		...
		<div class="inside">
			...
			<?php if ($we_have_logs):?>
				<div class="iump-form-line">
					...
					<div class="button button-primary button-large" onClick="ihc_do_clean_up_logs('user_logs', '<?php echo admin_url('admin.php?page=ihc_manage&tab=user_reports');?>');"><?php _e('Clean Up', 'ihc');?></div>
				</div>
				<div class="iump-form-line">
