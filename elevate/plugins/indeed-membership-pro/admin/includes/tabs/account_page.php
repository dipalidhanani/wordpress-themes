					...
					?>
						<div class="ihc-ap-tabs-list">
							<?php foreach ($available_tabs as $k=>$v):?>						
								<div class="ihc-ap-tabs-list-item" onClick="ihc_ap_make_visible('<?php echo $k;?>', this);" id="<?php echo 'ihc_tab-' . $k;?>"><?php echo $v['label'];?></div>	
							<?php endforeach;?>
							<div class="ihc-clear"></div>
						</div>				
					<?php
							...
							<div class="ihc-ap-tabs-settings-item" id="<?php echo 'ihc_tab_item_' . $k;?>" style="margin-top:20px;">
								...
								<div style="margin: 7px 0px;">
									...
									jQuery(document).ready(function(){
										var <?php echo 'ihc_shiny_object_' . $i;$i++;?> = new indeed_shiny_select({
